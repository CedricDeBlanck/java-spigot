...
public class Main extends JavaPlugin {
	...
	public void onEnable() {
		...
		getServer().getConsoleSender().sendMessage("§7[§4Veronica§7] §aPlugin successfully initialized!");
	}
	
	@Override
	public void onDisable() {
		getServer().getConsoleSender().sendMessage("§7[§4Veronica§7] §4Plugin successfully shutted down!");
	}
