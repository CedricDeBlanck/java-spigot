package me.SnakesDevelopment.SnFreeze.Config;
...
public class Config {
	...
	public void init(Plugin pl) {
		if(!pl.getDataFolder().exists()) {
			...
			Bukkit.getServer().getConsoleSender().sendMessage("[SnFreeze] Creating SnDrugs folder...");
			Bukkit.getServer().getConsoleSender().sendMessage("[SnFreeze] Succesfully created folder");
		}
	}
	...
	public static void createConfig(Plugin pl) {
		...
		if(!configFile.exists()) {
			...
			Bukkit.getServer().getConsoleSender().sendMessage("[SnFreeze] Creating config file...");
			Bukkit.getServer().getConsoleSender().sendMessage("[SnFreeze] Succesfully created config file");
		} else {
			return;
		}
